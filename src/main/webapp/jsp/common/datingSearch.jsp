   ...
   ================================================== -->
	...
	<div>
		<table border="1" width=1300>
			...
			<c:forEach items="${article}" var="node">
				<tr>
					<td><a
						href="${pageContext.request.contextPath}/DatingDetailView?datingName=${node.datingName }&datingId=${node.datingId}"><c:out
								value="${node.datingName}"></c:out></a></td>
					<td><c:out value="${node.datingSponsorName}"></c:out></td>
					<td><c:out value="${node.datingPerson}"></c:out></td>
