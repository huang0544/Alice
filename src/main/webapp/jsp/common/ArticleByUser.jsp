		...
		<div class="banner">我发表的文章</div>
			<div>
				<table border="1" width="100%">
					...
					<c:forEach items="${articleManage}" var="node">
						<tr>
							<td><a
								href="${pageContext.request.contextPath}/ArticleByUserDetail?articleId=${node.articleId }&articleName=${node.articleName}"><c:out
										value="${node.articleName}"></c:out></a></td>
